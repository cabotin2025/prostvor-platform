...
COPY public.finresources (finresource_id, title, description, finresource_type_id, attachment, deleted_at, created_at, updated_at, created_by, updated_by, rating_id, cost, currency, offering_term_id, special_terms) FROM stdin;
\.
...
CREATE INDEX idx_finresources_cost ON public.finresources USING btree (cost) WHERE (cost > (0)::numeric);
...
CREATE INDEX idx_finresources_offering_term ON public.finresources USING btree (offering_term_id);
...
CREATE INDEX idx_finresources_offering_term_cost ON public.finresources USING btree (offering_term_id, cost);
...
ALTER TABLE ONLY public.finresources
    ADD CONSTRAINT finresources_offering_term_id_fkey FOREIGN KEY (offering_term_id) REFERENCES public.offering_terms(id);
...
ALTER TABLE ONLY public.finresources
    ADD CONSTRAINT fk_finresources_offering_term FOREIGN KEY (offering_term_id) REFERENCES public.offering_terms(id);
