...
if (window.CommunicationsIconsLoaded) {
    console.log('communications-icons.js уже загружен, пропускаем');
    throw new Error('communications-icons.js уже загружен');
}
window.CommunicationsIconsLoaded = true;
